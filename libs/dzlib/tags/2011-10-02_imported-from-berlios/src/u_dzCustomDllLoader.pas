...
type
  ...
  public
    ...
    function TryGetProcAddress(const _EntryPoint: string; _DefaultFunc: pointer = nil): pointer; overload; virtual; abstract;
    ...
    ///          @returns a pointer to the entry pointer
    ///          @raises ENoEntryPoint on failure </summary>
    function TryGetProcAddress(const _EntryPoint: string; _DWordParams: integer; _DefaultFunc: pointer = nil): pointer; overload; virtual; abstract;
