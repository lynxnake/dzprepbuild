...
function Tdm_ManifestVersionInfo.GetChildNodeContent(_Parent: IXMLNode; const _NodeName, _AttrName: string): string;
var
  Node: IXMLNode;
begin
...
function Tdm_ManifestVersionInfo.GetVersionInfo(const _Name: string): string;
begin
  Result := GetChildNodeContent(FVersionInfo, 'VersionInfo', _Name);
end;

function Tdm_ManifestVersionInfo.GetVersionInfoKey(const _Name: string): string;
begin
  Result := GetChildNodeContent(FVersionInfoKeys, 'VersionInfoKeys', _Name);
end;

procedure Tdm_ManifestVersionInfo.SetChildNodeContent(_Parent: IXMLNode; const _NodeName, _AttrName, _Value: string);
var
  Node: IXMLNode;
begin
...
destructor Tdm_ManifestVersionInfo.Destroy;
begin
  FVersionInfo := nil;
  inherited;
end;
...
procedure Tdm_ManifestVersionInfo.SetVersionInfo(const _Name, _Value: string);
begin
  SetChildNodeContent(FVersionInfo, 'VersionInfo', _Name, _Value);
end;

procedure Tdm_ManifestVersionInfo.SetVersionInfoKey(const _Name, _Value: string);
begin
